                    ...
                    <div class="flex flex-col items-start gap-8 self-stretch">
                        <div class="flex flex-col items-start gap-3 self-stretch">
                            ...
                            <div class="flex items-center gap-2 w-full h-12px">
                                ...
                                <p class="w-full h-[17px] text-white font-poppins font-normal leading-[120%]" style="font-size: 12px;font-weight: 400;">Remember Me</p>
                                <a href="{{route('password.request')}}" class="w-[100%] h-[17px] text-white font-poppins font-normal leading-[120%]" style="font-size: 12px;font-weight: 400;">Forgot password</a>
                            </div>
