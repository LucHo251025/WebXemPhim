<div class="">
    <div class="container-subcription-page flex flex-col items-center gap-44 pt-[10%] pb-[10%]"> <!-- Thay pt-44 bằng pt-[100px] hoặc giá trị tương tự -->
        <div class="flex flex-col items-center gap-11 self-stretch">
            <div class="flex flex-col items-center gap-5">
                <p class="self-stretch text-white text-center font-poppins text-[80px] font-bold leading-[120%]">Choose Your Plan</p>
                <p class="self-stretch text-white text-center font-poppins text-[37px] font-normal leading-[120%]">Choose your plan to enjoy unlimited access to your Favourite Movies and Shows</p>
            </div>
            <div class="flex w-[569px] h-[119px] justify-center items-center " style="border-radius: 64px;border: 3px solid #7300FF;background:#000;">
                <button class="flex w-[274px] h-[103px] p-[42px_90px] justify-center items-center gap-3 flex-shrink-0" style="background:#7300FF;border-radius: 60px;">
                    <p class="text-white font-poppins text-[37px] font-normal font-[600] leading-[120%]">Monthly</p>
                </button>
                <button class="flex w-[275px] h-[103px] p-[42px_90px] justify-center items-center gap-3 rounded-[60px] flex-shrink-0">
                    <p class="text-white font-poppins text-[37px] font-normal font-[600] leading-[120%]">Yearly</p>
                </button>
            </div>
        </div>
        <div class="flex w-[489px] flex-col items-center" style="gap: -4px">
            <x-button type="">
                Most Popular
            </x-button>
